...
class AndOp extends Node {
    ...
    exec = function (scope) {
        ...
        returnSymbol =  this.generateAnd(scope)
    ...
    generateAnd = function (scope) {
        ...
        if (actualLeft.type == "boolean") {
            ...
            this.setNewCode("if (" + actualLeft.getValue() + " == 0) goto " + Node.falseTagIndex + ";")
            this.setNewLabel()
            ...
            if(actualRight.type == "boolean" && !(this.right instanceof AndOp || this.right instanceof OrOp)){
                this.setNewCode("if (" + actualRight.getValue() + " == 0) goto " + Node.falseTagIndex + ";")
                Node.gotoCode = true
            }
